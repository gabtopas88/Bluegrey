...
class StrategySignal:
    ...
    def add_order(self, key: str, contract: Contract, action: str, qty: float, order_type: str = 'MKT', limit_price: float = 0.0):
        """
        ...
        """
        order = {
            'key': key,          # <--- The Critical Addition for Backtesting
            'contract': contract,
            'action': action,
            'qty': qty,
            'type': order_type
