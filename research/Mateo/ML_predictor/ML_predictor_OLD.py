...
class MLPredictorStrategy(BaseStrategy):
    ...
    def download_dataset(self, symbol: str = None, start_date: str = None, end_date: str = None, actions: bool = None, training_years: float = None) -> pd.DataFrame:

        symbol = symbol or self.symbol
        start_date = start_date or self.start_date
        end_date = end_date or self.end_date

        # Download corporate actions only if they're needed or explicitly asked for
        if self.adj_method == "corporate_actions":
            actions = actions or True
    ...
    def load_stored_dataset(self, symbol: str = None, start_date: str = None, end_date: str = None, training_years: float = None) -> pd.DataFrame:
